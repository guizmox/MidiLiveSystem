...
namespace NAudio.Wave
{
	...
	public class RecordableMixerStream32 : NAudio.Wave.WaveStream
	{
		...
		/// </summary>
		public RecordableMixerStream32(int iSampleRate)
		{
			this.autoStop = true;
			this.waveFormat = WaveFormat.CreateIeeeFloatWaveFormat(iSampleRate, 2);
		...
		public RecordableMixerStream32(IEnumerable<WaveStream> inputStreams, bool autoStop, int iSampleRate)
			: this(iSampleRate)
		{
